...
`palette-core` is centered on graphics work in Kotlin. The technical target is: Quantize palettes and choose contrast-aware swatches.
...
The score is deterministic. The current threshold is 161. Risk has a penalty of 5, latency has a penalty of 2, and weight contributes a bonus of 4.
