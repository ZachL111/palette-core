...
palette-core is a Kotlin project for graphics. It focuses on this technical goal: Quantize palettes and choose contrast-aware swatches.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 161, risk penalty 5, latency penalty 2, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
