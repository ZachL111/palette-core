"""Regression checks for the palette-core casebook."""
...
from casebook.harness import assert_expected, palette_core_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(palette_core_summary(), assert_expected())
